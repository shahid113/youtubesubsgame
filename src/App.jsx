        ...
        {status === "revealed" && (
          <div className="mt-10 flex flex-col items-center gap-6">
            ...
            {result === "lose" && (
              <button
                onClick={shareScore}
                className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full font-bold hover:scale-105 transition shadow-md"
              >
                <svg
